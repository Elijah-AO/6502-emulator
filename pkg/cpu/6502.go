...
func NewCPU6502(bus memory.Bus) *CPU6502 {
	...
	cpu.lookup = [256]Instruction{
		...
		{"BMI", "REL", (*cpu).BMI, (*cpu).REL, 2}, {"AND", "IZY", (*cpu).AND, (*cpu).IZY, 5}, {"???", "IMP", (*cpu).XXX, (*cpu).IMP, 2}, {"???", "IMP", (*cpu).XXX, (*cpu).IMP, 8}, {"NOP", "IMP", (*cpu).NOP, (*cpu).IMP, 4}, {"AND", "ZPX", (*cpu).AND, (*cpu).ZPX, 4}, {"ROL", "ZPX", (*cpu).ROL, (*cpu).ZPX, 6}, {"???", "IMP", (*cpu).XXX, (*cpu).IMP, 6}, {"SEC", "IMP", (*cpu).SEC, (*cpu).IMP, 2}, {"AND", "ABY", (*cpu).AND, (*cpu).ABY, 4}, {"NOP", "IMP", (*cpu).NOP, (*cpu).IMP, 2}, {"???", "IMP", (*cpu).XXX, (*cpu).IMP, 7}, {"NOP", "IMP", (*cpu).NOP, (*cpu).IMP, 4}, {"AND", "ABX", (*cpu).AND, (*cpu).ABX, 4}, {"ROL", "ABX", (*cpu).ROL, (*cpu).ABX, 7}, {"???", "IMP", (*cpu).XXX, (*cpu).IMP, 7},
